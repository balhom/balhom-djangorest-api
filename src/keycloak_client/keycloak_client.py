...
class KeycloakClient:
    ...
    def access_tokens(self, email: str, password: str) -> dict:
        ...
        try:
            ...
            from src.app_auth.exceptions import WrongCredentialsException
            raise WrongCredentialsException() from exc
        except KeycloakPostError as exc:
            from src.app_auth.exceptions import UnverifiedEmailException
    ...
    def refresh_tokens(self, refresh_token: str) -> dict:
        ...
        try:
            ...
            from src.core.exceptions import AppUnauthorizedException
