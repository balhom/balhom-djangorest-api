...
import app_auth.models.user_model
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='users/default_user.jpg', upload_to=app_auth.models.user_model._image_user_dir, verbose_name='profile image')),
            ...
            managers=[
                ('objects', app_auth.models.user_model.BalanceUserManager()),
            ],
        ),
    ]
